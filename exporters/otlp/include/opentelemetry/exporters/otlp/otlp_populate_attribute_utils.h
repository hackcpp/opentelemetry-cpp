...
public:
  static void PopulateResource(opentelemetry::proto::resource::v1::Resource *proto,
                                const opentelemetry::sdk::resource::Resource &resource) noexcept;

  static void PopulateInstrumentationScope(opentelemetry::proto::common::v1::InstrumentationScope *proto,
