    ...
    bool allow_bytes) noexcept
{
    ...
    {
      proto_value->set_string_value(nostd::get<std::string>(value).data(),
...
void OtlpPopulateAttributeUtils::PopulateResource(
...
void OtlpPopulateAttributeUtils::PopulateInstrumentationScope(
