...
{
public:
  using CallBackFunc = std::function<bool(const std::string&, common::AttributeValue)>;
   ...
   */
  virtual bool ForEachKeyValue(CallBackFunc callback) const noexcept = 0;
...
public:
   ...
   */
  bool ForEachKeyValue(CallBackFunc /*callback*/)
